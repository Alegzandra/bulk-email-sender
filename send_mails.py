...
sender_address = 'alexandra.ciobotaru@unibuc.ro'
...
# we iterate the loop and send the messages one by one to the recivers 
...
Kind regards,    
Alexandra'''.format(name = receiver_name.title(), grade = receiver_grade)
